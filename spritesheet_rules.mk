...
FLDEFF_OUTDIR      := $(ASSETS_OBJ_DIR)/$(FLDEFFGFXDIR)
...
$(ASSETS_OBJ_DIR)/graphics/door_anims/battle_tower_multi_corridor.4bpp: graphics/door_anims/battle_tower_multi_corridor.png
	@mkdir -p $(@D)
	$(GFX) $< $@ -mwidth 2 -mheight 4
