...
static const u8 sAButton_Gfx[] = INCBIN_U8("build/assets/graphics/summary_screen/a_button.4bpp");
static const u8 sBButton_Gfx[] = INCBIN_U8("build/assets/graphics/summary_screen/b_button.4bpp");
